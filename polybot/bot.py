...
class QuoteBot(Bot):
    ...
    def handle_message(self, msg):
        ...
        # if msg['text'] != 'Please do not quote me':
        ...
        if self.is_current_msg_photo(msg):
            try:
                ...
                if not caption:
                    ...
                    self.send_text(msg['chat']['id'], "It's impossible to process a photo without caption. "
                        ...
                        if caption == 'blur':
                            ...
                            if self.data is None:
                                ...
                                self.send_text(chat_id,
                                                f"Send another photo for concatenation and choose direction : "
